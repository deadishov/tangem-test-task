...
import giftsImg from '../assets/images/gifts-top.png'
...
const BannerTop = () => {
    ...
    return (
        <div className='content__top-banner'>
            <div className="content__top-img">
                <img src={giftsImg} alt="gifts" />
            </div>
            <div className="content__top-text-limiter">
                <div
                    style={{ transform: `translateX(-${bannerScroll}px)` }}
                    className="content__top-text">
                    <p className="content__top-date">Black Friday<span className='quote'>,</span> <span>24-27 Nov</span></p>
                    <p className="content__top-text_golden">10%OFF</p>
                    <p className="content__top-code">Use code <span className='content__top-text_golden'>10FRIDAY</span> <span className='content__top-text_hiding'>at checkout</span></p>
                </div>
            </div>
            <div className="content__top-buttons">
                <button className="content__top-btn-shop"><p>Shop now</p></button>
                <button className="content__top-btn-close">
